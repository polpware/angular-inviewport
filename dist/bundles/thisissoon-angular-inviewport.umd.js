(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/Subject'), require('rxjs/observable/fromEvent'), require('rxjs/observable/merge'), require('rxjs/operators')) :
	typeof define === 'function' && define.amd ? define('@thisissoon/angular-inviewport', ['exports', '@angular/core', 'rxjs/Subject', 'rxjs/observable/fromEvent', 'rxjs/observable/merge', 'rxjs/operators'], factory) :
	(factory((global.thisissoon = global.thisissoon || {}, global.thisissoon['angular-inviewport'] = {}),global.ng.core,global.Rx,global.Rx.Observable,global.Rx.Observable,global.Rx.Observable.prototype));
}(this, (function (exports,core,Subject,fromEvent,merge,operators) { 'use strict';
...
var InViewportDirective = /** @class */ (function () {
    function InViewportDirective(el, windowRef, cdRef, ngZone) {
        ...
        this.cdRef = cdRef;
        this.ngZone = ngZone;
        this.viewport$ = new Subject.Subject();
    ...
    InViewportDirective.prototype.ngAfterViewInit = function () {
        ...
        this.ngZone.runOutsideAngular(function () {
            merge.merge(fromEvent.fromEvent((_this.windowRef), eventWindowResize), fromEvent.fromEvent((_this.windowRef), eventWindowScroll))
                .pipe(operators.auditTime(_this.debounce), operators.takeUntil(_this.ngUnsubscribe$))
                .subscribe(function () { return _this.onViewportChange(); });
        });
        if (this.parent) {
            this.ngZone.runOutsideAngular(function () {
                fromEvent.fromEvent(_this.parent, eventScroll)
                    .pipe(operators.auditTime(_this.debounce), operators.takeUntil(_this.ngUnsubscribe$))
